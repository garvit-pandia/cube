/*! min2phase.js — JavaScript port of min2phase (Herbert Kociemba two-phase algorithm),
 * Copyright (c) 2023 Chen Shuang, https://github.com/cs0x7f/min2phase.js.
 * Used under the MIT license option (MIT or GPL-3.0, see upstream package.json).
 * Vendored whole; only change for cube3: ESM default export appended for Vite. */
"use strict";
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined' && typeof module.exports === 'object') {
	try { module.exports = min2phase; } catch { /* ESM interop: export below */ }
}

// ESM interop for Vite: `import min2phase from './min2phase.js'`.
